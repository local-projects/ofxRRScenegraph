...
void BasicController::_setup(ofEventArgs &e) {
  setup();
}
void BasicController::_update(ofEventArgs &e) {
  update();
}
void BasicController::_draw(ofEventArgs &e) {
  draw();
}
void BasicController::_exit(ofEventArgs &e) {
  exit();
}
void BasicController::_keyPressed(ofKeyEventArgs &e) {
  keyPressed(e);
}
void BasicController::_keyReleased(ofKeyEventArgs &e) {
  keyReleased(e);
}
