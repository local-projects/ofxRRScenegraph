...
void BasicInteractiveObject::setDragThreshold(float _dragthreshold) {
  dragthreshold = _dragthreshold;
}
void BasicInteractiveObject::setScaleThreshold(float _scalethreshold) {
  scalethreshold = _scalethreshold;
}
void BasicInteractiveObject::setRotationThreshold(float _rotatethreshold) {
  rotatethreshold = _rotatethreshold;
}
void BasicInteractiveObject::setTapThreshold(float _tapThreshold) {
  tapThreshold = _tapThreshold;
}

void BasicInteractiveObject::setDragDamping(float _dragDamping) {
  dragdamp = _dragDamping;
};
void BasicInteractiveObject::setScaleDamping(float _scaleDamping) {
  scaledamp = _scaleDamping;
};
void BasicInteractiveObject::setRotationDamping(float _rotationDamping) {
  rotatedamp = _rotationDamping;
};
